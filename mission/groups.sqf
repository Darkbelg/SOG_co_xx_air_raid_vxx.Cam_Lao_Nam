...
_grpOPF = [
	...
	,["GrpOPF_ASL","Alpha","b_motor_inf","A",_red]
	,["GrpOPF_BSL","Bravo","b_motor_inf","B",_blue]
	,["GrpOPF_CSL","Charlie","b_motor_inf","C",_green]
	,["GrpOPF_DSL","Delta","b_support","D",_orange]
	,["GrpOPF_ESL","Echo","b_med","E",_black]
];
